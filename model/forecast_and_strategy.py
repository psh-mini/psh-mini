...
print("!!!This is the old model, don't use it, it will create new files (pngs and csvs) which you should delete!!!")
...
GENERATION_EFFICIENCY = 0.95        # efficiency of power generation
