...
//i2c config
#define I2CMCR_0 (*((volatile uint32_t *) 0x40020020))
#define I2CMTPR_0 (*((volatile uint32_t *) 0x4002000C))
#define I2CMSA_0 (*((volatile uint32_t *) 0x40020000))
#define I2CMDR_0 (*((volatile uint32_t *) 0x40020008))
#define I2CMCS_0 (*((volatile uint32_t *) 0x40020004))
#define SRI2C (*((volatile uint32_t *) 0x400FE520))
...
#define GPIOODR_B (*((volatile uint32_t *) 0x4005950C))
#define GPIOPCTL_B (*((volatile uint32_t *) 0x4005952C))
